    ...
    */
    ...
    public class DynamicDecals : MonoBehaviour
    {
        ...
        private bool FireInCulling
        {
            get
            {
                return !(VRSettings.enabled || Settings.Replacement == ShaderReplacementType.VR);
            }
        }
    ...
    internal class CameraData
    {
        ...
        private void UpdateRenderingMethod(Camera Camera, DynamicDecals System)
        {
            ...
            ShaderReplacement shaderReplacement = Standard(VRSettings.enabled && Camera.stereoTargetEye != StereoTargetEyeMask.None);
